		...
		<div class="item">
			...
			<div class="markup">
				{foreach item="image" from=$article.images}
					<a href="{$__.config.siteUrl}images/fancybox/articles/{$image.filename}" rel="fancybox" class="articles_{$article.id}" title="{$image.alt|escape}">
			...
			<a class="button" href="{$__.config.siteUrl}over-ons">&laquo; Terug naar overzicht</a>
		</div>
		{* article *}
