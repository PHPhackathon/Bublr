{capture 'content'}
	...
	<div id="content">
		...
		{loop $articles}
			<div class="item">
				<h2><a href="{$__.config.siteUrl}over-ons/{$quicklink}">{$title|escape}</a></h2>
				<div class="markup">
					{if $image_filename}
						<a href="{$__.config.siteUrl}over-ons/{$quicklink}">
				...
				<a class="button right" href="{$__.config.siteUrl}over-ons/{$quicklink}">Lees verder &raquo;</a>
			</div>
		{/loop}
		{* articles *}
