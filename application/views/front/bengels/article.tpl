		...
		<div class="item">
			...
			<div class="markup">
				{foreach item="image" from=$article.images}
					<a href="{$__.config.siteUrl}images/fancybox/articles/{$image.filename}" class="fancybox" rel="article_{$article_id}" title="{$image.alt|escape}">
			...
			<a class="button" href="{$__.config.siteUrl}bengels">&laquo; Terug naar (B)engels</a>
		</div>
		{* article *}
